...
function DriverHistoryScreen({}) {
    ...
    const [withdrawalPresent, setWithdrawalPresent] = useState(false);
    ...
    useEffect(()=>{
        ...
        if(sampleTrips.length !== 0) {
            ...
            setDataPresent(true);
            setWithdrawalPresent(true);
        }
        else {
            setDataPresent(false);
            setWithdrawalPresent(false);
        }
    },[sampleTrips])
        ...
        <Screen>
            ...
            {viewMode === 1 &&
                <View style={styles.withdrawalContainer}>
                    ...
                    {!withdrawalPresent && <NoDataAnimation visible={!withdrawalPresent}/>}
                </View>
            }
        </Screen>
    );
