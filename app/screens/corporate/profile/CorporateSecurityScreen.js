...
function CorporateSecurityScreen({ navigation }) {
    const {user} = useAuth();
    ...
    const handleSubmit = async ({ password, confirmpassword }, { resetForm }) => {
        ...
        const result = await corporateApi.updateCorporateSecurityProfile(user.userId.toString(), {
            password: password
        });
...
export default CorporateSecurityScreen;